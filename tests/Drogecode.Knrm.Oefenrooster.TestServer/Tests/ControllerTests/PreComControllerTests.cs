...
{
    public PreComControllerTests(TestService testService) : base(testService)
    {
    }
    ...
    public async Task WebHookIOSTest()
    {
        ...
        await Tester.PreComController.WebHook(Tester.DefaultCustomerId, DefaultSettingsHelperMock.IdTaco, asObject, false);
    ...
    public async Task PutPreComForwardTest()
    {
        ...
        var result = await Tester.PreComController.PutForward(body);
    ...
    public async Task AllForwardsTest()
    {
        ...
        var allResult = await Tester.PreComController.AllForwards(30, 0);
    ...
    public async Task PatchForwardTest()
    {
        ...
        var patchResult = await Tester.PreComController.PatchForward(body);

...
namespace MudBlazor
{
    public partial class DrogeCodeMudTabs : MudComponentBase, IAsyncDisposable
    {
        ...
        [Parameter]
        [Category(CategoryTypes.Tabs.Behavior)]
        public RenderFragment<DrogeCodeMudTabPanel> PrePanelContent { get; set; }
        ...
        public DrogeCodeMudTabPanel ActivePanel { get; private set; }
        ...
        /// </summary>
        public IReadOnlyList<DrogeCodeMudTabPanel> Panels { get; private set; }

        private List<DrogeCodeMudTabPanel> _panels;
        ...
        [Parameter]
        [Category(CategoryTypes.Tabs.Behavior)]
        public RenderFragment<DrogeCodeMudTabs> Header { get; set; }
        ...
        [Parameter]
        [Category(CategoryTypes.Tabs.Behavior)]
        public DrogeCodeTabHeaderPosition HeaderPosition { get; set; } = DrogeCodeTabHeaderPosition.After;
        ...
        [Parameter]
        [Category(CategoryTypes.Tabs.Behavior)]
        public RenderFragment<DrogeCodeMudTabPanel> TabPanelHeader { get; set; }
        ...
        [Parameter]
        [Category(CategoryTypes.Tabs.Behavior)]
        public DrogeCodeTabHeaderPosition TabPanelHeaderPosition { get; set; } = DrogeCodeTabHeaderPosition.After;
        ...
        [Parameter]
        [Category(CategoryTypes.Tabs.Behavior)]
        public Func<DrogeCodeTabInteractionEventArgs, Task> OnPreviewInteraction { get; set; }
        ...
        public DrogeCodeMudTabs()
        {
            _panels = new List<DrogeCodeMudTabPanel>();
        ...
        internal void AddPanel(DrogeCodeMudTabPanel tabPanel)
        {
        ...
        internal async Task RemovePanel(DrogeCodeMudTabPanel tabPanel)
        {
            if (_isDisposed)
                return;
        ...
        public void ActivatePanel(DrogeCodeMudTabPanel panel, bool ignoreDisabledState = false)
        {
        ...
        private async void ActivatePanel(DrogeCodeMudTabPanel panel, MouseEventArgs ev, bool ignoreDisabledState = false)
        {
            if (!panel.Disabled || ignoreDisabledState)
            {
                var index = _panels.IndexOf(panel);
                var previewArgs = new DrogeCodeTabInteractionEventArgs { PanelIndex = index, InteractionType = DrogeCodeTabInteractionType.Activate };
        ...
        string GetTabClass(DrogeCodeMudTabPanel panel)
        {
        ...
        string GetTabStyle(DrogeCodeMudTabPanel panel)
        {
        ...
        private double GetLengthOfPanelItems(DrogeCodeMudTabPanel panel, bool inclusive = false)
        {
            var value = 0.0;
        ...
        private double GetPanelLength(DrogeCodeMudTabPanel panel) => panel == null ? 0.0 : GetRelevantSize(panel.PanelRef);
        ...
        private bool ScrollToItem(DrogeCodeMudTabPanel panel, bool isLast = false)
        {
        ...
        private void CenterScrollPositionAroundSelectedItem()
        {
            ...
            DrogeCodeMudTabPanel panelToStart = ActivePanel;

...
public static class DefaultSettingsHelper
{
    ...
    [Obsolete("Use appsetting DrogeCode:SuperAdmin")]
    public static Guid IdTaco { get; } = new Guid("04a6b34a-c517-4fa0-87b1-7fde3ebc5461"); // "04093c7a-11e5-4887-af51-319ecc59efe0"

...
public class GenerateUserRole
{
    ...
    // Helper method to extract group name from constant name
    static string GetGroupName(string fieldName)
    {
        if (fieldName.StartsWith("AUTH_"))
        {
            return fieldName.Substring(5).Split('_')[0].ToLower();
        }

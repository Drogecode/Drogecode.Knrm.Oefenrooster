...
public interface IScheduleService
{
    ...
    Task<ScheduleForAllResponse> ScheduleForAllAsync(Guid userId, Guid customerId, int yearStart, int monthStart, int dayStart, int yearEnd, int monthEnd, int dayEnd, CancellationToken token);

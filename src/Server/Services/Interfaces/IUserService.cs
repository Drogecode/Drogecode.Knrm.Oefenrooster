...
public interface IUserService
{
    ...
    Task<GetOrSetDrogeUser?> GetOrSetUserById(Guid? userId, string? externalId, string userName, string userEmail, Guid customerId, bool setLastOnline, CancellationToken clt);

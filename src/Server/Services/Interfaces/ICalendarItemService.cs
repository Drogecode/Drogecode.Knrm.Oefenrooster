...
namespace Drogecode.Knrm.Oefenrooster.Server.Services.Interfaces
{
    public interface ICalendarItemService
    {
        ...
        Task<GetMultipleDayItemResponse> GetAllFutureDayItems(Guid customerId, int count, int skip, CancellationToken clt);
        Task<GetDayItemResponse> GetDayItemById(Guid customerId, Guid id, CancellationToken clt = default);

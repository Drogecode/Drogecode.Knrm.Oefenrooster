...
namespace Drogecode.Knrm.Oefenrooster.Server.Services.Interfaces
{
    public interface ICalendarItemService
    {
        ...
        Task<GetDayItemResponse> GetDayItems(int yearStart, int monthStart, int dayStart, int yearEnd, int monthEnd, int dayEnd, Guid customerId, CancellationToken clt);

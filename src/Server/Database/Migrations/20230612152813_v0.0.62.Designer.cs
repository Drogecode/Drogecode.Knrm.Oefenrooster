...
namespace Drogecode.Knrm.Oefenrooster.Server.Database.Migrations
{
    ...
    [Migration("20230612152813_v0.0.62")]
    partial class v0062
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbUserDefaultAvailable", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Available = 1,
                            CustomerId = new Guid("d9754755-b054-4a9c-a77f-da42a4009365"),
                            RoosterDefaultId = new Guid("7b4693a8-ae9c-430f-9119-49a6ecbfeb54"),
                            UserId = new Guid("04093c7a-11e5-4887-af51-319ecc59efe0"),
                            ValidFrom = new DateTime(2022, 9, 4, 0, 0, 0, 0, DateTimeKind.Utc),
                            ValidUntil = new DateTime(2023, 12, 31, 23, 59, 59, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            ...
                            Available = 3,
                            CustomerId = new Guid("d9754755-b054-4a9c-a77f-da42a4009365"),
                            RoosterDefaultId = new Guid("2bdaccc0-e9f7-40c1-ae76-d9ed66e4a978"),
                            UserId = new Guid("04093c7a-11e5-4887-af51-319ecc59efe0"),
                            ValidFrom = new DateTime(2023, 6, 12, 0, 0, 0, 0, DateTimeKind.Utc),
                            ValidUntil = new DateTime(2023, 9, 30, 23, 59, 59, 0, DateTimeKind.Utc)
                        });
                });
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbUserHolidays", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerId = new Guid("d9754755-b054-4a9c-a77f-da42a4009365"),
                            UserId = new Guid("04093c7a-11e5-4887-af51-319ecc59efe0"),
                            ValidFrom = new DateTime(2023, 7, 5, 0, 0, 0, 0, DateTimeKind.Utc),
                            ValidUntil = new DateTime(2023, 10, 17, 23, 59, 59, 0, DateTimeKind.Utc)
                        });
                });

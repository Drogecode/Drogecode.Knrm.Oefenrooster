...
namespace Drogecode.Knrm.Oefenrooster.Server.Database.Migrations
{
    ...
    [Migration("20251018123257_PreventDeletingHuiActionsAndTrainings")]
    partial class PreventDeletingHuiActionsAndTrainings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbLinkReportTrainingRoosterTraining", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ReportTrainingId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RoosterTrainingId")
                        .HasColumnType("uuid");

                    b.Property<DateTime?>("SetByExternalOn")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ReportTrainingId");

                    b.HasIndex("RoosterTrainingId");

                    b.ToTable("LinkReportTrainingRoosterTraining");
                });
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbRoosterTraining", b =>
                {
                    ...
                    b.Property<bool>("IsPermanentPinned")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbUserPreComEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("SyncWithExternal")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbUsersGlobal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = new Guid("b4bcc37b-321a-4027-b02b-30630ad8f75e"),
                            CreatedOn = new DateTime(1992, 9, 4, 1, 4, 8, 0, DateTimeKind.Utc),
                            Name = "Taco Droogers"
                        });
                });
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbLinkReportTrainingRoosterTraining", b =>
                {
                    b.HasOne("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbCustomers", "Customer")
                        .WithMany("LinkReportTrainingRoosterTrainings")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbReportTraining", "ReportTraining")
                        .WithMany("LinkReportTrainingRoosterTrainings")
                        .HasForeignKey("ReportTrainingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbLinkUserCustomer", b =>
                {
                    ...
                    b.HasOne("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbUsersGlobal", "LinkedUser")
                        .WithMany("LinkUserCustomers")
            ...
            modelBuilder.Entity("Drogecode.Knrm.Oefenrooster.Server.Database.Models.DbCustomers", b =>
                {
                    ...
                    b.Navigation("LinkReportTrainingRoosterTrainings");

...
namespace Drogecode.Knrm.Oefenrooster.ClientGenerator.Client
{
    ...
    public partial interface ISharePointClient
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetHistoricalResponse> SyncHistoricalAsync();

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<GetHistoricalResponse> SyncHistoricalAsync(System.Threading.CancellationToken cancellationToken);
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<MultipleSharePointTrainingsResponse> GetLastTrainingsForCurrentUserAsync(int count, int skip, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/SharePoint/training/user/{count}/{skip}"
                    urlBuilder_.Append("api/SharePoint/training/user/");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<MultipleSharePointTrainingsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        public virtual async System.Threading.Tasks.Task<MultipleSharePointTrainingsResponse> GetLastTrainingsAsync(string users, int count, int skip, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/SharePoint/training/{users}/{count}/{skip}"
                    urlBuilder_.Append("api/SharePoint/training/");
        ...
        public virtual async System.Threading.Tasks.Task<MultipleSharePointActionsResponse> GetLastActionsForCurrentUserAsync(int count, int skip, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/SharePoint/action/user/{count}/{skip}"
                    urlBuilder_.Append("api/SharePoint/action/user/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(count, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(skip, System.Globalization.CultureInfo.InvariantCulture)));
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<MultipleSharePointActionsResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        public virtual async System.Threading.Tasks.Task<MultipleSharePointActionsResponse> GetLastActionsAsync(string users, int count, int skip, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/SharePoint/action/{users}/{count}/{skip}"
                    urlBuilder_.Append("api/SharePoint/action/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(users, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(count, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append('/');
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<GetHistoricalResponse> SyncHistoricalAsync()
        {
            return SyncHistoricalAsync(System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<GetHistoricalResponse> SyncHistoricalAsync(System.Threading.CancellationToken cancellationToken)
        {
            var client_ = _httpClient;
            var disposeClient_ = false;
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/SharePoint/historical"
                    urlBuilder_.Append("api/SharePoint/historical");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetHistoricalResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }

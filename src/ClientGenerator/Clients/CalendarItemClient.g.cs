...
namespace Drogecode.Knrm.Oefenrooster.ClientGenerator.Client
{
    ...
    public partial class CalendarItemClient : ICalendarItemClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<GetMonthItemResponse> GetMonthItemsAsync(int? year, int? month)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<GetMonthItemResponse> GetMonthItemsAsync(int? year, int? month, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetMonthItemResponse>(response_, headers_).ConfigureAwait(false);
                        ...
                        return default(GetMonthItemResponse);
                    }
                    finally
                    {
                        if (response_ != null)
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<GetDayItemResponse> GetDayItemsAsync(int? yearStart, int? monthStart, int? dayStart, int? yearEnd, int? monthEnd, int? dayEnd)
        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<GetDayItemResponse> GetDayItemsAsync(int? yearStart, int? monthStart, int? dayStart, int? yearEnd, int? monthEnd, int? dayEnd, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "200") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetDayItemResponse>(response_, headers_).ConfigureAwait(false);
                            return objectResponse_.Object;
                        }
                        else
                        if (status_ != "200" && status_ != "204")
                        ...
                        return default(GetDayItemResponse);
                    }
                    finally
                    {
                        if (response_ != null)

...
namespace Drogecode.Knrm.Oefenrooster.ClientGenerator.Client
{
    ...
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.6.1.0 (NJsonSchema v11.5.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class MonthItemClient : IMonthItemClient
    {
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public MonthItemClient(System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<GetMonthItemResponse> ByIdAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/MonthItem/{id}"
                    urlBuilder_.Append("api/MonthItem/");
        ...
        {
            return GetItemsAsync(year, month, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<GetMultipleMonthItemResponse> GetItemsAsync(int year, int month, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/MonthItem/{year}/{month}"
                    urlBuilder_.Append("api/MonthItem/");
        ...
        {
            return GetAllItemsAsync(take, skip, includeExpired, System.Threading.CancellationToken.None);
        }
        ...
        public virtual async System.Threading.Tasks.Task<GetMultipleMonthItemResponse> GetAllItemsAsync(int take, int skip, bool includeExpired, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (includeExpired == null)
                throw new System.ArgumentNullException("includeExpired");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/MonthItem/all/{take}/{skip}/{includeExpired}"
                    urlBuilder_.Append("api/MonthItem/all/");
                    ...
                    urlBuilder_.Append('/');
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(includeExpired, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        {
            return PutItemAsync(body, System.Threading.CancellationToken.None);
        }
        ...
        {
            return PatchItemAsync(body, System.Threading.CancellationToken.None);
        }
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PatchMonthItemResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        {
            return DeleteMonthItemAsync(body, System.Threading.CancellationToken.None);
        }

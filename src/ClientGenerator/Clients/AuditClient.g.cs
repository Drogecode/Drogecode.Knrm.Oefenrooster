...
namespace Drogecode.Knrm.Oefenrooster.ClientGenerator.Client
{
    ...
    public partial class AuditClient : IAuditClient
    {
        ...
        public virtual async System.Threading.Tasks.Task<GetTrainingAuditResponse> GetTrainingAuditAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append("api/Audit/training/{id}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<GetTrainingAuditResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
